...
class _HomePageState extends State<ProjectsPagetwo> with SingleTickerProviderStateMixin {
  ...
  final List<String> _domainFilters = ['AI', 'ML', 'Web Development', 'Mobile Development', 'Data Science'];
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        const Spacer(),
                        if (_selectedIdentityFilter != null || _selectedDomainFilter != null)
                          Container(
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: ChoiceChip(
                                ...
                                selected: _selectedIdentityFilter == null && _selectedDomainFilter == null,
                                selectedColor: darkBlue,
                                backgroundColor: Colors.grey.shade100,
                                labelStyle: TextStyle(
                                  color: _selectedIdentityFilter == null && _selectedDomainFilter == null
                                      ? Colors.white
                            ...
                            ...List.generate(_identityFilters.length, (index) {
                              ...
                              final isSelected = _selectedIdentityFilter == filter;
                              return Padding(
                                padding: const EdgeInsets.only(right: 8),
                                child: ChoiceChip(
                                  label: Text(filter),
                                  ...
                                  onSelected: (selected) {
                                    setState(() {
                                      _selectedIdentityFilter = selected ? filter : null;
                                    });
                                  },
                                ),
                              );
                            ...
                            ...List.generate(_domainFilters.length, (index) {
                              ...
                              return Padding(
                                ...
                                child: ChoiceChip(
                                  ...
                                  onSelected: (selected) {
                                    setState(() {
                                      _selectedDomainFilter = selected ? filter : null;
                                    });
                                  },
                                ),
                              );
                ...
                child: StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    var projects = snapshot.data!.docs.where((doc) {
                      ...
                      bool matchesIdentity = _selectedIdentityFilter == null || identity == _selectedIdentityFilter;
                      bool matchesDomain = _selectedDomainFilter == null || tags.contains(_selectedDomainFilter);
                    ...
                    return Padding(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final tags = (projectData['tags'] as List<dynamic>?)?.map((tag) => tag.toString()).toList() ?? [];

                          return FutureBuilder<double>(
                            future: user != null ? _getUserProgress(user.uid, projectId) : Future.value(0.0),
                            builder: (context, progressSnapshot) {
                              ...
                              return _buildModernProjectCard(
                                ...
                                identity,
                                tags,
                                projectData['collegeName'] ?? projectData['companyName'] ?? 'Eduspark',
                                progress,
                                progressPercent,
                                    () {
                                  Navigator.push(
                ...
                if (_isFabExpanded) ...[
                  _buildNavigationFabItem(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => CasestudiesHomePage()),
                      );
                    },
                  ),
                  const SizedBox(height: 16),
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Icon(
                              identity == 'College' ? Icons.school_rounded :
                              identity == 'Company' ? Icons.business_rounded :
                              identity == 'App Developer' ? Icons.developer_mode_rounded :
                              Icons.school_rounded,
                              color: accentColor,
                              size: 16,
                            ),
                          ...
                          children: [
                            Container(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Icon(
                                    hasStarted ? Icons.play_circle_filled_rounded : Icons.radio_button_unchecked_rounded,
                                    size: 14,
                                    color: hasStarted ? accentColor : Colors.grey.shade500,
                                  ),
                                  const SizedBox(width: 4),
                                  Text(
                  ...
                  Container(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        backgroundColor: hasStarted ? Colors.white : primaryBlue,
                        foregroundColor: hasStarted ? primaryBlue : Colors.white,
                      ...
                      child: Row(
                        ...
                        children: [
                          Icon(
                            hasStarted ? Icons.play_arrow_rounded : Icons.rocket_launch_rounded,
                            size: 18,
                          ),
                          const SizedBox(width: 6),
                          Text(
      ...
      builder: (context) => Dialog(
        ...
        child: Container(
          constraints: BoxConstraints(
            maxHeight: screenHeight * 0.8, // Limit height to 80% of screen height
          ),
                  ...
                  child: Column(
                    children: [
                      _buildInfoItem(
                        ...
                        description: "Each level starts with a quiz (8 questions, 60 seconds each). Score 8/8 to unlock submission. 2 attempts allowed, with a 3-day retry if you fail.",
                      ...
                      _buildInfoItem(
                        ...
                        description: "Submit code or text solutions after passing the quiz. Your work is verified against expected outputs or keywords.",
                      ...
                      _buildInfoItem(
                        ...
                        description: "See your progress with a bar and percentage for each project.",
